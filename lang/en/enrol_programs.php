...
$string['evidenceupload_markedascompleted'] = 'Evidence marked completed for {$a} users';
$string['evidenceupload_skipped'] = '{$a} skipped';
$string['evidenceupload_errors'] = '{$a} errors detected when trying to update evidence';
...
$string['uploadotherevidence'] = 'Other completion evidence upload';
$string['uploadotherevidence_csvfile'] = 'CSV file';
