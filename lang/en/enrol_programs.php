...
$string['source_selfallocation_deallocate'] = 'Remove allocation';
$string['source_selfallocation_deallocate_confirm'] = 'Please confirm that you want to be deallocated from the program.';
$string['source_selfallocation_deallocated'] = 'You have been deallocated from \'{$a}\'.';
